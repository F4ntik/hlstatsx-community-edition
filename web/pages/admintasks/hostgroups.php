...
*/
	...
	$edlist->columns[] = new EditListColumn("pattern", t('admin.hostgroups.field.host_pattern'), 30, true, "text", "", 128);
	$edlist->columns[] = new EditListColumn("name", t('admin.hostgroups.field.group_name'), 30, true, "text", "", 128);
...
?>
<?php echo t('admin.hostgroups.help_html'); ?>
<?php $result = $db->query("
		SELECT
			id,
			pattern,
