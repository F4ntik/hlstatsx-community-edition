...
*/
	...
	$edlist->columns[] = new EditListColumn("address", t('admin.field.ip_address'), 15, true, "ipaddress", "", 15);
	$edlist->columns[] = new EditListColumn("port", t('admin.server_port'), 5, true, "text", "27015", 5);
	$edlist->columns[] = new EditListColumn("name", t('literal.server_name'), 35, true, "text", "", 255);
	$edlist->columns[] = new EditListColumn("rcon_password", t('admin.rcon_password'), 10, false, "password", "", 128);
	$edlist->columns[] = new EditListColumn("publicaddress", t('admin.public_address'), 20, false, "text", "", 128);
	$edlist->columns[] = new EditListColumn("game", t('admin.field.game'), 20, true, "select", "hlstats_Games.name/code/realgame='".$realgame."'");
	$edlist->columns[] = new EditListColumn("sortorder", t('admin.field.sort_order'), 2, true, "text", "", 255);
