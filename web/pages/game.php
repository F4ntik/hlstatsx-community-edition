...
?>
		<tr class="data-table-row">
			<td style="text-align:center;padding:0px;">
				<img src="show_graph.php?type=1&amp;game=<?php echo $game ?>&amp;width=870&amp;height=200&amp;bgcolor=<?php echo $g_options['graphbg_load']; ?>&amp;color=<?php echo $g_options['graphtxt_load']; ?>" alt="<?php echo eHtml(t('literal.server_load_graph')); ?>" title="<?php echo eHtml(t('literal.server_load_graph')); ?>" />
			</td>
		</tr>
<?php
		}
