...
Визуальное продолжение 12 сентября выполнено: чёткие пятна, раздельные цвета в «Оба»,
инверсия и автоматическая подготовка BSP. [Кандидат выпуска](release-heatmap-20260912.md)
